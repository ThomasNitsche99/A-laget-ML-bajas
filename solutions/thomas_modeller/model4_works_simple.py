...
test_data = pd.read_csv('data/raw/ais_test.csv')
...
output.to_csv('vessel_position_predictions_4.csv', index=False)

print("Predictions saved to 'vessel_position_predictions_4.csv'")
